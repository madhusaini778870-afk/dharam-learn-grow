...
export const Route = createFileRoute("/my-learning")({
  head: () => ({
    meta: [
      { title: "My Learning · Dharam Bhai Study" },
      {
        name: "description",
        content: "The courses you have enrolled in, saved to your account and available after every sign-in.",
      },
      { property: "og:title", content: "My Learning · Dharam Bhai Study" },
      { property: "og:description", content: "The courses you have enrolled in, saved to your account." },
    ],
  }),
      ...
      <div className="mt-4 space-y-3 px-5">
        ...
        {enrollments.data?.length === 0 ? (
          <StateCard
            ...
            body="Browse the catalog and enroll to start tracking your progress here."
            action={
              <Link
                to="/courses"
        ...
        {enrollments.data?.map((item) => {
          const rows = progress.data?.filter((p) => p.course_id === item.course_id) ?? [];
